Maak een javascript bestand aan genaamd Opdracht-2.js, maak hier de volgende oefening in en probeer van iedere opdracht een commit te maken en deze te pushen naar de repo
